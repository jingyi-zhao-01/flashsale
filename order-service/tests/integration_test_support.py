"""Order-service test wrapper for the shared compose integration helpers."""
...
def _load_support_module() -> ModuleType:
    """Load the shared compose integration helper module from application/flashsale/scripts."""
...
compose_exec = _SUPPORT.compose_exec
