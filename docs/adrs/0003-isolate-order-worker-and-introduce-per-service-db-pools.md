...
- `application/flashsale/order-service/app/db_pool.py`
- `application/flashsale/product-service/app/db_pool.py`
- `application/flashsale/user-service/app/db_pool.py`
...
- `application/flashsale/order-service/app/main.py`
- `application/flashsale/order-service/app/entrypoints/http_api.py`
- `application/flashsale/order-service/app/entrypoints/worker_main.py`
- `application/flashsale/order-service/app/db_pool.py`
- `application/flashsale/order-service/app/adapters/order_postgres_repository.py`
- `application/flashsale/order-service/app/adapters/terminalization_task_postgres_repository.py`
...
- `application/flashsale/user-service/app/db_pool.py`
- `application/flashsale/user-service/app/repositories.py`
- `charts/flashsales/templates/order-deployment.yaml`
- `charts/flashsales/templates/order-worker-deployment.yaml`
- `charts/flashsales/templates/service-configmaps.yaml`
- `charts/flashsales/values.yaml`
